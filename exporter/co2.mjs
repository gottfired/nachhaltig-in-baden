...
const data = [
    {
        title: "mindful mission",
        description: `mindful mission ist ein junges Startup, das die Kompensation der CO2
        ...
        web: "https://www.mindfulmission.earth",
        image: "https://www.mindfulmission.earth/assets/img/logo-mindfulmission.13115599.svg",
    ...
    },
    {
        ...
        image: "https://www.atmosfair.de/wp-content/themes/inspirekt_child/images/atmosfair_logo_de.png",
    ...
    },
    {
        ...
        image: "http://www.klimaktiv.de/media/images/01_logos/intern/klimaktiv/logo_klimaktiv.svg",
...
export function generate() {
    ...
    const template = fs.readFileSync(path.join(__dirname, "/CO2Komp_template.html"), "utf8");
    ...
    fs.writeFileSync("CO2Komp.html", template.replace("{head}", head).replace("{content}", entries));
}
